(function () {
  ...
  const insertStarsBtn = document.getElementById('btn-insert-stars');
  ...
  const insertNumberStars = document.getElementById('input-insert-stars');
  ...
  (function attachEventListeners() {
    ...
    insertStarsBtn.addEventListener('click', insertStarHandler)
  })();

function insertStarHandler() {
  let num = +insertStarsBtn
  let toInsert = "ocko".repeat(num)
  myArray.push("*".repeat(num));

    insertContainerStars(toInsert);
}
  ...
  function insertContainerStars(num) {
    let div = document.createElement('div');
    div.className = 'block';
    let span = document.createElement('span');
    span.className = 'value';
